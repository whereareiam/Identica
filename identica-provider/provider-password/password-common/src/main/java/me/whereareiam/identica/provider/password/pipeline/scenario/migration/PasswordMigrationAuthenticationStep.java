...
@Singleton
public class PasswordMigrationAuthenticationStep extends AbstractPasswordStep {
	...
	@Inject
	public PasswordMigrationAuthenticationStep(
		...
		super("password-migration-authentication");
