...
- latest release: <MavenVersionLink
    metadataUrl="https://maven.whereareiam.me/release/me/whereareiam/identica/api/maven-metadata.xml"
    hrefTemplate="https://maven.whereareiam.me/javadoc/release/me/whereareiam/identica/api/{version}"
    selector="release"
  />
- latest development build: <MavenVersionLink
    metadataUrl="https://maven.whereareiam.me/development/me/whereareiam/identica/api/maven-metadata.xml"
    hrefTemplate="https://maven.whereareiam.me/javadoc/development/me/whereareiam/identica/api/{version}"
    selector="latest"
  />
