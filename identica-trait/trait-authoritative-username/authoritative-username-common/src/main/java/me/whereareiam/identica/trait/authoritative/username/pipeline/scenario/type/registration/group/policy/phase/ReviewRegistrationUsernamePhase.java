...
public class ReviewRegistrationUsernamePhase implements PipelinePhase<PolicyState> {
	...
	public @NotNull CompletionStage<PhaseResult<PolicyState>> execute(@NotNull PipelineState pipelineState, @NotNull PolicyState state) {
		...
		RegistrationContext context = pipelineState.getScenario(pipelineState.getPipelineType()) instanceof RegistrationContext registrationContext
				? registrationContext
				: null;
