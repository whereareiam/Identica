package me.whereareiam.identica.trait.authoritative.username.pipeline.scenario.type.authentication.group.identity.phase;
...
@Singleton
public class SynchronizeAuthenticationUsernamePhase extends AbstractSynchronizeUsernamePhase<IdentityState> {
	@Inject
	public SynchronizeAuthenticationUsernamePhase(
	...
	protected @Nullable ScenarioContext scenarioContext(@NotNull PipelineState pipelineState, @NotNull IdentityState state) {
		return pipelineState.getScenario(PipelineType.AUTHENTICATION) instanceof AuthContext authContext
				? authContext
				: null;
	}
